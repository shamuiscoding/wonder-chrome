...
//   const outermostElements = getOutermostElements(elements as Node[]);
//   console.log(outermostElements);

//   for (const element of outermostElements) {
//     if (element) {
//       modifyElement(element, 'Hello, world!', 'original');
//       appendDiff(element, 'Hello, world!', 'modified');
//     }
//   }
// });

// function modifyElement(element: Node, text: string, type: 'original' | 'modified') {
//   if (type === 'original') {
...
// function getSelectedElements(selection: Selection) {
...
// function appendDiff(element: Node, text: string, type: 'original' | 'modified') {
...
// function getOutermostElements(elements: Node[]) {
